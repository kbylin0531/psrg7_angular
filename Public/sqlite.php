...
$file =  __DIR__.'/../Config/sqlite.php';
if(is_file($file)){
...
$password = empty($configuration['passwd']) ? 'acerantor' : $configuration['passwd'];

//directory relative to this file to search for databases (if false, manually list databases in the $databases variable)
$directory = empty($configuration['directory']) ? __DIR__.'/../Data/litedb' : $configuration['directory'];
if(!is_dir($directory)){
