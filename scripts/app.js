...
angular.module("app").controller("MainController",
    ["navService", "$mdSidenav", "$mdBottomSheet", "$log", "$q", "$state", "$mdToast", function e(e, a, t, n, o, i, r) {
        function d() {
            a("right").toggle()
        }
...
angular.module("angularMaterialAdmin", ["ngAnimate", "ngCookies", "ngTouch", "ngSanitize", "ui.router", "ngMaterial", "nvd3", "app"])
    .config(["$stateProvider", "$urlRouterProvider", "$mdThemingProvider", "$mdIconProvider", function (e, a, t, n) {
    e.state("home", {
        url: "",
