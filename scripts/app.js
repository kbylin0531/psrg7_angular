!function () {
    ...
    "use strict";
    function e() {
        var e = [{name: "Afghanistan", code: "AF"}, {name: "Åland Islands", code: "AX"}, {
            name: "Albania",
            code: "AL"
    ...
    function e() {
        function e() {
            for (var e = [], a = 0; 100 > a; a++)e.push({x: a, y: Math.abs(.25 * Math.cos(a / 10) * a + .9 - .4 * a)});
            return [{values: e, color: "rgb(0, 150, 136)", area: !0}]
        }

        var a = this;
        a.warningsChartData = e, a.chartOptions = {
            chart: {
                type: "lineChart",
                height: 210,
    ...
    function e(e) {
        function a() {
            i.todoText && (i.todos.push({text: i.todoText, done: !1}), i.todoText = "")
        }
        ...
        function n(e) {
            e.preventDefault();
            var a = i.todos;
            i.todos = [], angular.forEach(a, function (e) {
        ...
        var i = this;
        i.addTodo = a, i.remaining = t, i.archive = n, i.toggleAll = o, i.todos = [], e.loadAllItems().then(function (e) {
            i.todos = [].concat(e)
        })
    }
    ...
    function e(e) {
        var a = this;
        a.tableData = [], e.loadAllItems().then(function (e) {
    ...
    function e(e, a, t) {
        function n(t) {
            ...
            return n = a.defer(), e(function () {
                n.resolve(r)
            }, 1e3 * Math.random(), !1), n.promise
        }
        ...
        var i = this;
        i.countries = t.loadAll(), i.selectedCountry = null, i.searchText = null, i.querySearch = n, i.disableCaching = !0
    }
    ...
    function e(e, a) {
        ...
        }, i.performanceChartData = [], i.performancePeriod = "week", i.changePeriod = o, t()
    }
    ...
    function e(e) {
        var a = this;
        a.messages = [], e.loadAllItems().then(function (e) {
            a.messages = [].concat(e)
        })
    }
    ...
    function e() {
        var e = this;
        e.memoryChartData = [{key: "memory", y: 42}, {key: "free", y: 58}], e.chartOptions = {
            chart: {
                type: "pieChart",
                height: 210,
                donut: !0,
    ...
    function e(e, a, t, n, o, i, r) {
        ...
        function l(e) {
            u.title = e.name, u.toggleItemsList(), u.showSimpleToast(u.title)
        }
        ...
        var u = this;
        u.menuItems = [], u.selectItem = l, u.toggleItemsList = s, u.showActions = m, u.title = i.current.data.title, u.showSimpleToast = c, u.toggleRightSidebar = d, e.loadAllItems().then(function (e) {
    ...
    function e(e, a) {
        function t() {
            o.showProgress = !0, interval = a(function () {
                o.determinateValue += 1, o.determinateValue > 100 && (o.determinateValue = 10, o.showProgress = !1, n(), a.cancel(interval))
            }, 50, 0, !0)
        }
        ...
        var o = this;
        o.buttonEnabled = !1, o.showProgress = !1, o.reloadServer = "Staging", o.performProgress = t, o.determinateValue = 10
    }
